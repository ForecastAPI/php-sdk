# ForecastAPI\Sdk\InventoryPlanningApi
...
```php
createInventoryPlan($inventory_planning_request): \ForecastAPI\Sdk\Model\InventoryPlanningResponse
```
...
| ------------- | ------------- | ------------- | ------------- |
| **inventory_planning_request** | [**\ForecastAPI\Sdk\Model\InventoryPlanningRequest**](../Model/InventoryPlanningRequest.md)|  | |

### Return type

[**\ForecastAPI\Sdk\Model\InventoryPlanningResponse**](../Model/InventoryPlanningResponse.md)

# ForecastAPI\Sdk\TrafficForecastingApi
...
```php
createTrafficForecast($traffic_forecasting_request): \ForecastAPI\Sdk\Model\TrafficForecastingResponse
```
...
| ------------- | ------------- | ------------- | ------------- |
| **traffic_forecasting_request** | [**\ForecastAPI\Sdk\Model\TrafficForecastingRequest**](../Model/TrafficForecastingRequest.md)|  | |

### Return type

[**\ForecastAPI\Sdk\Model\TrafficForecastingResponse**](../Model/TrafficForecastingResponse.md)

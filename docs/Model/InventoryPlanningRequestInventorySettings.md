...
**suppliers** | [**\ForecastAPI\Sdk\Model\InventoryPlanningRequestInventorySettingsSuppliersInner[]**](InventoryPlanningRequestInventorySettingsSuppliersInner.md) | Available suppliers with their characteristics |

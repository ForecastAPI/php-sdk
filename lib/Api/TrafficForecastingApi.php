...
class TrafficForecastingApi
{
    ...
    public function v2TrafficForecastingPostRequest($traffic_forecasting_request, string $contentType = self::contentTypes['v2TrafficForecastingPost'][0])
    {
        ...
        $resourcePath = '/v2/traffic-forecasting';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($traffic_forecasting_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($traffic_forecasting_request));
            } else {
                $httpBody = $traffic_forecasting_request;
            }

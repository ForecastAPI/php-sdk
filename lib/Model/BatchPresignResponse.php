...
/**
 * BatchPresignResponse Class Doc Comment
 *
 * @category Class
 * @package  ForecastAPI\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class BatchPresignResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchPresignResponse';
    ...
    */
     ...
     * Sets upload_url
     *
     * @param string|null $upload_url Presigned URL — HTTP PUT the JSON file here, including any returned headers
     *
     * @return self
     */
     ...
     * Sets headers
     *
     * @param array<string,string>|null $headers Headers that must be sent with the upload request
     *
     * @return self
     */
     ...
     * Sets file_key
     *
     * @param string|null $file_key Pass this as `file_key` to POST /v2/batch/forecast after uploading
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Seconds the upload URL stays valid
     *
     * @return self
     */

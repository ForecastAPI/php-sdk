...
/**
 * ForecastPeriod Class Doc Comment
 *
 * @category Class
 * @package  ForecastAPI\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ForecastPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ForecastPeriod';
    ...
    */
     ...
     * Sets period
     *
     * @param int|null $period 1-based forecast period number
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date Date of this forecast period
     *
     * @return self
     */
     ...
     * Sets forecast
     *
     * @param float|null $forecast Point forecast for this period
     *
     * @return self
     */
     ...
     * Sets lower
     *
     * @param float|null $lower Lower prediction bound at the requested confidence level
     *
     * @return self
     */
     ...
     * Sets upper
     *
     * @param float|null $upper Upper prediction bound at the requested confidence level
     *
     * @return self
     */
     ...
     * Sets quantiles
     *
     * @param array<string,float>|null $quantiles Present only when `quantiles` was requested — the forecast at each requested decile level for this period
     *
     * @return self
     */

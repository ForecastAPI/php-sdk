...
/**
 * ProductInsightsBatchStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  ForecastAPI\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ProductInsightsBatchStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductInsightsBatchStatusResponse';
    ...
    */
     ...
     * Sets batch_parts
     *
     * @param int|null $batch_parts batch_parts
     *
     * @return self
     */
     ...
     * Sets results
     *
     * @param array<string,mixed>|null $results Summary and per-product analysis results as parts complete
     *
     * @return self
     */
     ...
     * Sets parts
     *
     * @param array<string,mixed>[]|null $parts Per-part progress, each carrying its analyses once processed
     *
     * @return self
     */

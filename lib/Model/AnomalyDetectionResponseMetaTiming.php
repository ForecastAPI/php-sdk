...
/**
 * AnomalyDetectionResponseMetaTiming Class Doc Comment
 *
 * @category Class
 * @package  ForecastAPI\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class AnomalyDetectionResponseMetaTiming implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnomalyDetectionResponse_meta_timing';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('detection', $data ?? [], null);
    ...
    */
     ...
     * Sets validation
     *
     * @param float|null $validation validation
     *
     * @return self
     */
    ...
    {
        return $this->container['detection'];
    }

    /**
     * Sets detection
     *
     * @param float|null $detection detection
     *
     * @return self
     */
    public function setDetection($detection)
    {
        if (is_null($detection)) {
            throw new \InvalidArgumentException('non-nullable detection cannot be null');
        }
        $this->container['detection'] = $detection;

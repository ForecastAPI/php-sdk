...
/**
 * AnomalyDetectionRequest Class Doc Comment
 *
 * @category Class
 * @package  ForecastAPI\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class AnomalyDetectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnomalyDetectionRequest';
    ...
    protected static $openAPITypes = [
        ...
        'anomaly_settings' => '\ForecastAPI\Sdk\Model\AnomalyDetectionRequestAllOfAnomalySettings'
    ];
    ...
    protected static $setters = [
        ...
        'data' => 'setData',
        'anomaly_settings' => 'setAnomalySettings'
    ];
    ...
    protected static $getters = [
        ...
        'data' => 'getData',
        'anomaly_settings' => 'getAnomalySettings'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('anomaly_settings', $data ?? [], null);
    }
    ...
    */
    ...
    public function setPeriods($periods)
    {
        ...
        if (($periods < 1)) {
            throw new \InvalidArgumentException('invalid value for $periods when calling AnomalyDetectionRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setConfidenceLevel($confidence_level)
    {
        ...
        if (($confidence_level > 0.99)) {
            throw new \InvalidArgumentException('invalid value for $confidence_level when calling AnomalyDetectionRequest., must be smaller than or equal to 0.99.');
        }
        if (($confidence_level < 0.1)) {
            throw new \InvalidArgumentException('invalid value for $confidence_level when calling AnomalyDetectionRequest., must be bigger than or equal to 0.1.');
        }
    ...
    public function setQuantiles($quantiles)
    {
        ...
        if ((count($quantiles) > 9)) {
            throw new \InvalidArgumentException('invalid value for $quantiles when calling AnomalyDetectionRequest., number of items must be less than or equal to 9.');
        }
        if ((count($quantiles) < 1)) {
            throw new \InvalidArgumentException('invalid length for $quantiles when calling AnomalyDetectionRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setAdjustments($adjustments)
    {
        ...
        if ((count($adjustments) > 20)) {
            throw new \InvalidArgumentException('invalid value for $adjustments when calling AnomalyDetectionRequest., number of items must be less than or equal to 20.');
        }
        if ((count($adjustments) < 1)) {
            throw new \InvalidArgumentException('invalid length for $adjustments when calling AnomalyDetectionRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setData($data)
    {
        ...
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling AnomalyDetectionRequest., number of items must be greater than or equal to 1.');
        }
    ...
    /**
     * Gets anomaly_settings
     *
     * @return \ForecastAPI\Sdk\Model\AnomalyDetectionRequestAllOfAnomalySettings|null
     */
    public function getAnomalySettings()
    {
        return $this->container['anomaly_settings'];
    }

    /**
     * Sets anomaly_settings
     *
     * @param \ForecastAPI\Sdk\Model\AnomalyDetectionRequestAllOfAnomalySettings|null $anomaly_settings anomaly_settings
     *
     * @return self
     */
    public function setAnomalySettings($anomaly_settings)
    {
        if (is_null($anomaly_settings)) {
            array_push($this->openAPINullablesSetToNull, 'anomaly_settings');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('anomaly_settings', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['anomaly_settings'] = $anomaly_settings;

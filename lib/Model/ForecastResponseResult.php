...
class ForecastResponseResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets model_info
     *
     * @param array<string,mixed>|null $model_info The selected model (`best_model`), the models evaluated, the interval source, and per-model back-testing scores (smape/mape/mase) when validation runs. Also carries `bounds_transform` when `value_bounds` was sent, `quantile_levels` when a fan was requested, and `auto_selection` (see the AutoSelection schema) when `model: auto` was requested.
     *
     * @return self
     */

 ...
 */
class TrafficForecastingResponseResultTrafficAlerts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrafficForecastingResponse_result_traffic_alerts';
    ...
    {
        $this->setIfExists('total_alerts', $data ?? [], null);
        $this->setIfExists('high_severity', $data ?? [], null);
        $this->setIfExists('medium_severity', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['total_alerts'];
    }

    /**
     * Sets total_alerts
     *
     * @param int|null $total_alerts Total number of alerts generated
     *
     * @return self
     */
    public function setTotalAlerts($total_alerts)
    {
        if (is_null($total_alerts)) {
            throw new \InvalidArgumentException('non-nullable total_alerts cannot be null');
        }
        $this->container['total_alerts'] = $total_alerts;
     ...
     * Sets high_severity
     *
     * @param int|null $high_severity Number of high severity alerts
     *
     * @return self
     */
    public function setHighSeverity($high_severity)
    {
        if (is_null($high_severity)) {
            throw new \InvalidArgumentException('non-nullable high_severity cannot be null');
        }
     ...
     *
     * @param int|null $medium_severity Number of medium severity alerts
     *
     * @return self
     */
    public function setMediumSeverity($medium_severity)
    {
        if (is_null($medium_severity)) {
            throw new \InvalidArgumentException('non-nullable medium_severity cannot be null');
        }

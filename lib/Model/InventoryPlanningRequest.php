 ...
 */
class InventoryPlanningRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InventoryPlanningRequest';
    ...
    protected static $setters = [
        ...
        'data' => 'setData',
        'inventory_settings' => 'setInventorySettings'
    ];
    ...
    protected static $getters = [
        ...
        'data' => 'getData',
        'inventory_settings' => 'getInventorySettings'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('inventory_settings', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inventory_settings'] === null) {
            $invalidProperties[] = "'inventory_settings' can't be null";
        }
     ...
     * Sets identifier
     *
     * @param string $identifier SKU, Product ID, or other identifier for the inventory item
     *
     * @return self
     */
     ...
     * Sets frequency
     *
     * @param string $frequency Data frequency for forecasting: - D: Daily - W: Weekly - M: Monthly (end of month) - MS: Monthly (start of month) - ME: Monthly (end of month) - Q: Quarterly - Y: Yearly
     *
     * @return self
     */
    ...
    public function setPeriods($periods)
    {
        ...
        if (($periods < 1)) {
            throw new \InvalidArgumentException('invalid value for $periods when calling InventoryPlanningRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setConfidenceLevel($confidence_level)
    {
        ...
        if (($confidence_level > 0.99)) {
            throw new \InvalidArgumentException('invalid value for $confidence_level when calling InventoryPlanningRequest., must be smaller than or equal to 0.99.');
        }
        if (($confidence_level < 0.1)) {
            throw new \InvalidArgumentException('invalid value for $confidence_level when calling InventoryPlanningRequest., must be bigger than or equal to 0.1.');
        }
    ...
    public function setData($data)
    {
        ...
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling InventoryPlanningRequest., number of items must be greater than or equal to 1.');
        }
    ...
    {
        return $this->container['inventory_settings'];
    }
     ...
     * @return self
     */
    public function setInventorySettings($inventory_settings)
    {
        if (is_null($inventory_settings)) {
            throw new \InvalidArgumentException('non-nullable inventory_settings cannot be null');
        }
        $this->container['inventory_settings'] = $inventory_settings;

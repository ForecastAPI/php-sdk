 ...
 */
class ValueBounds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValueBounds';
    ...
    */
     ...
     * Sets min
     *
     * @param float|null $min Floor the series cannot go below
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float|null $max Ceiling the series cannot exceed
     *
     * @return self
     */
